  ...
  render() {
    ...
    return (
      <div>
        ...
        {!this.state.flip &&
          <div className={this.props.post.role === 'mentor' ? `${cardSize}__ribbon` : `${cardSize}__ribbon--green`}>
            <span className={this.props.post.role === 'mentor' ? `${cardSize}__ribbon-span` : `${cardSize}__ribbon-span--green`}>{roleText}</span>
          </div> }

          ...
          <div className="view-preview__name">{this.props.profile.currentProfile.name}</div>
            ...
            {this.props.profile.currentProfile.location &&
              ...
              <div className="view-preview__card-nav">
                <div
                  className="view-preview__card-nav-item"
                  name='skills'
                  onClick={e => this.onClick(e)}
                  >
                  <i className="fa fa-code view-preview__icon--skills" aria-hidden="true" />
                  <span
                    className="view-preview__card-nav-item-text"
                ...
                <div
                  ...
                  name='languages'
                  onClick={e => this.onClick(e)}>
                  <i className="fa fa-commenting-o view-preview__icon--languages" aria-hidden="true" />
                  <span className="view-preview__card-nav-item-text"
                ...
                <div
                  ...
                  name='about'
                  onClick={e => this.onClick(e)}>
                  <i className="fa fa-user view-preview__icon--about" aria-hidden="true" />
                  <span className="view-preview__card-nav-item-text"
                  id='about'>About</span>
                </div>
              </div>

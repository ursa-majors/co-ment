                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="">
                            <div>
                              <!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${url}" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="80%" stroke="f" fillcolor="#178f8f">
                            ...
                            <tbody>
                              <tr>
                                <td style="color:#ffffff;" class="">&nbsp;
                                  ...
                                  <p style="color: white; font-size: 1.2em; line-height: 1.4em;font-weight:100; text-align: left; padding: 0 20px;">
                                    Please click the link below to verify your email. Once your account is verified you can build your profile, create and edit posts, and connect with other users.
                                  </p>
                                  <br /> &nbsp; <br />
                                </td>
                              </tr>
                                  ...
                                  <div>
                                    <!--[if mso]>
                                      ...
                                      <w:anchorlock></w:anchorlock>
                                        <center>
                                    <![endif]-->
                                    <a class="button" href="${url}">Validate Account</a>
                                    <!--[if mso]>
                                        </center>
                                      </v:roundrect>
                                    <![endif]-->
